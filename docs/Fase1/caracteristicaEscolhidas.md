---
title: Características Escolhidas e Critérios de Priorização
sidebar_position: 7
---
...
A seleção das características foi diretamente influenciada pelo propósito do Mural UnB e pelo tipo de produto desenvolvido. A plataforma possui como objetivo centralizar, organizar e recomendar oportunidades acadêmicas e profissionais para estudantes da Universidade de Brasília, utilizando mecanismos de busca, categorização e recomendação personalizada.

Por se tratar de uma aplicação web colaborativa acessada por múltiplos usuários em diferentes dispositivos, características relacionadas ao correto funcionamento das funcionalidades, ao desempenho durante o acesso simultâneo e à compatibilidade entre ambientes foram consideradas prioritárias.

Características como segurança, confiabilidade e manutenibilidade também são relevantes para o sistema, porém não foram priorizadas nesta avaliação devido ao escopo definido para o trabalho e ao foco nas características mais diretamente associadas à experiência de uso da plataforma.

### Relação com o Propósito

As características priorizadas possuem relação direta com o propósito declarado da avaliação e com os objetivos principais do Mural UnB.

A **Adequação Funcional** está relacionada à capacidade do sistema de fornecer corretamente funcionalidades essenciais, como recomendações, pesquisa de oportunidades, exibição de conteúdos e navegação pelas informações acadêmicas disponíveis na plataforma.

A **Eficiência de Desempenho** está associada à necessidade de garantir tempos de resposta adequados durante a utilização da plataforma, especialmente em funcionalidades relacionadas ao feed personalizado, recomendações por similaridade e carregamento das páginas.

Já a **Portabilidade** está relacionada à necessidade de disponibilizar o sistema para diferentes perfis de usuários e dispositivos, garantindo acessibilidade e compatibilidade em ambientes desktop e mobile, permitindo maior alcance e democratização do acesso às oportunidades divulgadas.
