...
4. Executar o Lighthouse nas páginas selecionadas, no perfil desktop e no perfil mobile. Cada execução do Lighthouse deve ser repetida **3 vezes** para a mesma página e perfil, registrando-se a **mediana** dos valores obtidos como resultado oficial, a fim de mitigar variações causadas por flutuações de rede, CPU ou processos concorrentes no dispositivo de teste.
5. Para o perfil mobile, utilizar a emulação do Chrome DevTools com o dispositivo **iPhone 12 Pro (390×844px)**, com o throttling padrão do Lighthouse ativo (Simulated Throttling: CPU 4x slowdown, rede Fast 3G simulada com RTT de 150ms e throughput de 1.6 Mbps).
6. Exportar os relatórios gerados pelo Lighthouse em HTML e armazená-los no repositório, preferencialmente em diretório de evidências ou em `static/relatorios/` quando forem exibidos no Docusaurus.
7. Registrar em tabela os valores brutos de LCP, TBT, Performance Score, Best Practices, Accessibility e SEO.
8. Executar os casos de uso manuais definidos neste plano, registrando sucesso, falha, comportamento inesperado ou limitação observada.
9. Capturar evidências visuais das telas avaliadas, principalmente quando houver quebra de layout, falha funcional ou comportamento relevante para a análise.
10. Verificar a completude dos dados exibidos em uma amostra de publicações/cards, conforme a métrica M3 de Adequação Funcional.
11. Comparar os dados coletados com as rubricas de pontuação da Fase 2 apenas na etapa de análise da Fase 4.
12. Registrar eventuais limitações da coleta, como indisponibilidade de navegador, ausência de dispositivo físico, massa de dados reduzida ou diferença entre ambiente local e produção.
...
| :---------------------------------------------------- | :------------------------------- | :---------------------- | :---------------------------------------------------------------- |
| Revisar métricas, questões e rubricas da Fase 2       | Raissa Oliveira e João Guimarães | 02/06/2026              | Lista final de métricas rastreadas.                               |
| Preparar ambiente e massa de dados                    | Davi Negreiros                   | 03/06/2026              | Registro do ambiente e observação sobre disponibilidade de dados. |
| Executar Lighthouse em desktop e mobile               | Diogo Barboza                    | 04/06/2026 – 05/06/2026 | Relatórios HTML exportados e tabela de métricas brutas.           |
| Executar testes manuais de funcionalidades            | Ana Carolina e Raissa Oliveira   | 04/06/2026 – 06/06/2026 | Checklist preenchido e capturas de tela.                          |
| Executar inspeção de responsividade e compatibilidade | João Guimarães e Davi Negreiros  | 05/06/2026 – 06/06/2026 | Capturas de tela e registro de navegadores/dispositivos.          |
| Organizar evidências no repositório e Docusaurus      | Diogo Barboza e Ana Carolina     | 07/06/2026 – 08/06/2026 | Links para relatórios, imagens e tabelas de coleta.               |
| Encaminhar dados para análise da Fase 4               | Equipe completa                  | 09/06/2026              | Conjunto de dados brutos e consolidados prontos para julgamento.  |
